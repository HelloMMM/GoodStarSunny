...
open class SpotlightViewController: UIViewController {
    ...
    fileprivate func setupSpotlightView(_ alpha: CGFloat) {
        ...
        view.addConstraints([NSLayoutConstraint.Attribute.top, .bottom, .left, .right].map {
            NSLayoutConstraint(item: self.view!, attribute: $0, relatedBy: .equal, toItem: spotlightView, attribute: $0, multiplier: 1, constant: 0)
            })
    }
    ...
    fileprivate func setupContentView() {
        ...
        view.addConstraints([NSLayoutConstraint.Attribute.top, .bottom, .left, .right].map {
            NSLayoutConstraint(item: self.view!, attribute: $0, relatedBy: .equal, toItem: contentView, attribute: $0, multiplier: 1, constant: 0)
            })
    }
